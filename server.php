...
if ($action === "submit") {
  ...
  if ($group_number === "") out(["ok" => false, "error" => "group_required"]);
  if ($group_members === "") out(["ok" => false, "error" => "members_required"]);
  if ($project_title === "") out(["ok" => false, "error" => "title_required"]);
